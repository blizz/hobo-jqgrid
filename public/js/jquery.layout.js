  ...
  $.fn.layout = function(opts) {
    ...
    var execUserCallback = function(pane, v_fn) {
      ...
      try {
        ...
        if (typeof fn == "function") return fn(pane, $Ps[pane], $.extend({},
        state[pane]), $.extend({},
        options[pane]), options.name);
      } catch(ex) {}
    };
    ...
    var initOptions = function() {
      ...
      c.center = $.extend(true, {},
      c.defaults, c.center);
      $.extend(options.center, opts.center);
      var o_Center = $.extend(true, {},
      options.defaults, opts.defaults, options.center);
      ...
      $.each(c.borderPanes.split(","), function(i, pane) {
        ...
        options.defaults, options[pane], opts.defaults, opts[pane]);
        ...
        $.each(["_open", "_close", ""], function(i, n) {
          ...
          fx_pane = fx[pane] || {};
          o[sSettings] = $.extend({},
          fx_all, fx_pane, defs.fxSettings || {},
          defs[sSettings] || {},
          o.fxSettings, o[sSettings], opts.defaults.fxSettings, opts.defaults[sSettings] || {},
          opts[pane].fxSettings, opts[pane][sSettings] || {});
    ...
    function keyDown(evt) {
      ...
      else $.each(c.borderPanes.split(","), function(i, p) {
        o = options[p];
        k = o.customHotkey;
