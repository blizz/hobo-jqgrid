  ...
  $.fn.jqGrid = function(p) {
    ...
    var grid = {
      ...
      dragStart: function(i, x, y) {
        ...
        $(".ui-jqgrid-resize-mark", "#gbox_" + p.id).css({
          visibility: "visible",
          left: y[0],
          top: y[1],
          height: y[2]
    ...
    return this.each(function() {
      ...
      if (this.p.subGrid) {
        ...
        this.p.colModel.unshift({
          name: "subgrid",
          width: isSafari ? ts.p.subGridWidth + ts.p.cellLayout: ts.p.subGridWidth,
          sortable: false,
          resizable: false,
          hidedlg: true,
          search: false
      ...
      tdc, idn, w, res, sort, td, ptr, tbody;
    ...
    filterGrid: function(c, b) {
      ...
      return this.each(function() {
        ...
        var h = function() {
          ...
          a.each(l.p.filterModel, function(s, u) {
            switch (this.stype) {
            case "select":
              m = a("select[name=" + this.name + "]", l).val();
              if (m) {
                p[this.index] = m;
                if (l.p.marksearched) {
                  a("#jqgh_" + this.name, n.grid.hDiv).addClass("dirty-cell")
                }
                o++
              } else {
                if (l.p.marksearched) {
                  a("#jqgh_" + this.name, n.grid.hDiv).removeClass("dirty-cell")
                }
                try {
                  delete n.p.postData[this.index]
                } catch(t) {}
              }
              break;
            default:
              m = a("input[name=" + this.name + "]", l).val();
              if (m) {
                p[this.index] = m;
                if (l.p.marksearched) {
                  a("#jqgh_" + this.name, n.grid.hDiv).addClass("dirty-cell")
        ...
        var k = function() {
          ...
          a.each(l.p.filterModel, function(s, v) {
            m = (this.defval) ? this.defval: "";
            if (!this.stype) {
              this.stype == "text"
            }
            switch (this.stype) {
            case "select":
              if (m) {
                var u;
                a("select[name=" + this.name + "] option", l).each(function() {
                  if (a(this).text() == m) {
                    this.selected = true;
                    u = a(this).val();
                    return false
              ...
              break;
            case "text":
              a("input[name=" + this.name + "]", l).val(m);
              if (m) {
                p[this.index] = m;
                if (l.p.marksearched) {
                  a("#jqgh_" + this.name, n.grid.hDiv).addClass("dirty-cell")
        ...
        var i = function() {
          ...
          a.each(l.p.filterModel, function(A, v) {
            ...
            case "text":
              ...
              a(r).append("<input type='text' name='" + this.name + "' id='sg_" + this.name + "' value='" + B + "'/>");
              if (z.sopt) {
    ...
    filterToolbar: function(b) {
      ...
      return this.each(function() {
        ...
        var c = function() {
          ...
          a.each(g.p.colModel, function(q, s) {
            switch (this.stype) {
            case "select":
              l = a("select[name=" + this.name + "]", g.grid.hDiv).val();
              if (l) {
                n[this.index] = l;
                m++
              } else {
                try {
                  delete g.p.postData[this.index]
                } catch(r) {}
              }
              break;
            case "text":
              l = a("input[name=" + this.name + "]", g.grid.hDiv).val();
              if (l) {
                n[this.index] = l;
                m++
              } else {
          ...
          var o = m > 0 ? true: false;
          g.p.postData = a.extend(g.p.postData, n);
          var p;
          if (g.p.searchurl) {
            p = g.p.url;
            a(g).setGridParam({
        ...
        var j = function() {
          ...
          a.each(g.p.colModel, function(q, t) {
            l = (this.defval) ? this.defval: "";
            switch (this.stype) {
            case "select":
              if (l) {
                var s;
                a("select[name=" + this.name + "] option", g.grid.hDiv).each(function() {
                  if (a(this).text() == l) {
                    this.selected = true;
                    s = a(this).val();
                    return false
              ...
              break;
            case "text":
              a("input[name=" + this.name + "]", g.grid.hDiv).val(l);
              if (l) {
                n[this.index] = l;
                m++
              } else {
        ...
        var k = function() {
          a("tr.ui-search-toolbar", g.grid.hDiv).toggle()
        };
        function f(l, n) {
          var m = a(l);
          if (m[0] != null) {
        ...
        a.each(g.p.colModel, function(s, o) {
          ...
          if (this.search) {
            ...
            case "text":
              ...
              a(i).append("<input type='text' style='width:95%;padding:0px;' name='" + u.name + "' id='gs_" + u.name + "' value='" + t + "'/>");
              if (e.attr) {
...
var createModal = function(i, d, a, k, m, l) {
  ...
  if (jQuery.fn.jqm && a.jqModal === true) {
    ...
    jQuery("a.ui-jqdialog-titlebar-close", b).click(function(n) {
...
var hideModal = function(a, c) {
  ...
  if (jQuery.fn.jqm && c.jqm === true) {
    ...
    if (c.gb != "") {
      try {
        jQuery(".jqgrid-overlay:first", c.gb).hide()
      } catch(b) {}
    }
          ...
          if (b("#" + g).html() != null) {
            ...
            if (n.length > 0) {
              ...
              if (c.multipleSearch === false) {
                b(".ui-del, .ui-add, .ui-del, .ui-add-last, .matchText, .rulesText", "#" + g).remove();
...
//          j = [];
    ...
    editGridRow: function(c, d) {
      ...
      return this.each(function() {
        ...
        B = b.isFunction(a.beforeShowForm) ? a.beforeShowForm: false,
        M = b.isFunction(a.afterShowForm) ? a.afterShowForm: false,
        L = b.isFunction(a.beforeInitData) ? a.beforeInitData: false,
        ...
        if (b("#" + h.themodal).html() != null) {
          ...
          m(c, e, w);
          if (c == "_empty") {
            b("#pData, #nData", "#" + s).hide()
          } else {
            b("#pData, #nData", "#" + s).show()
          }
          if (d.processing === true) {
            d.processing = false;
            b("#sData", "#" + s).removeClass("ui-state-active")
          }
          if (b("#" + w).data("disabled") === true) {
            b(".confirm", "#" + h.themodal).hide();
            b("#" + w).data("disabled", false)
          }
          if (B) {
            B(b("#" + w))
          }
          ...
          b(e.p.colModel).each(function(S) {
            var T = this.formoptions;
            H = Math.max(H, T ? T.colpos || 0 : 0);
            p = Math.max(p, T ? T.rowpos || 0 : 0)
          });
          var K, P = b("<form name='FormPost' id='" + w + "' class='FormGrid'></form>").data("disabled", false),
          y = b("<table id='" + s + "' class='EditTable' cellspacing='0' cellpading='0' border='0' width='100%'><tbody></tbody></table>");
          b(P).append(y);
          K = b("<tr id='FormError' style='display:none'><td class='ui-state-error' colspan='" + (H * 2) + "'></td></tr>");
          K[0].rp = 0;
          b(y).append(K);
          if (a.topinfo) {
            K = b("<tr><td class='topinfo' colspan='" + (H * 2) + "'>" + a.topinfo + "</td></tr>");
            K[0].rp = 0;
            b(y).append(K)
          }
          if (L) {
          ...
          r = "<a href='javascript:void(0)' id='cData' class='fm-button ui-state-default ui-corner-all'>" + d.bCancel + "</a>";
          K = b("<tr id='Act_Buttons'><td class='navButton ui-widget-content'>" + k + l + "</td><td colspan='" + (H * 2 - 1) + "' class='EditButton ui-widget-content'>" + g + "&nbsp;" + r + "</td></tr>");
          K[0].rp = 900;
          b(y).append(K);
          if (a.bottominfo) {
            K = b("<tr><td class='bottominfo' colspan='" + (H * 2) + "'>" + a.bottominfo + "</td></tr>");
            K[0].rp = 901;
            b(y).append(K)
          }
          if (p > 0) {
            var v = [];
            b.each(b(y)[0].rows, function(S, T) {
              v[S] = T
            });
            v.sort(function(T, S) {
              if (T.rp > S.rp) {
          ...
          createModal(h, P, d, "#gview_" + e.p.id, b("#gview_" + e.p.id)[0]);
          jQuery("#" + h.themodal).keydown(function(S) {
            if (b("#" + w).data("disabled") === true) {
              return false
            }
            if (a.savekey[0] === true && S.which == a.savekey[1]) {
              b("#sData", "#" + s).trigger("click");
              return false
            }
            if (S.which === 27) {
              if (!f()) {
            ...
            if (a.navkeys[0] === true) {
              if (b("#id_g", "#" + s).val() == "_empty") {
                return true
              }
              if (S.which == a.navkeys[1]) {
                b("#pData", "#" + s).trigger("click");
                return false
              }
              if (S.which == a.navkeys[2]) {
                b("#nData", "#" + s).trigger("click");
                return false
              }
            }
          });
          ...
          if (d.saveicon[0] == true) {
            b("#sData", "#" + s).addClass(d.saveicon[1] == "right" ? "fm-button-icon-right": "fm-button-icon-left").append("<span class='ui-icon " + d.saveicon[2] + "'></span>")
          }
          if (d.closeicon[0] == true) {
            b("#cData", "#" + s).addClass(d.closeicon[1] == "right" ? "fm-button-icon-right": "fm-button-icon-left").append("<span class='ui-icon " + d.closeicon[2] + "'></span>")
          }
          if (a.checkOnSubmit || a.checkOnUpdate) {
            ...
            r = "<a href='javascript:void(0)' id='cNew' class='fm-button ui-state-default ui-corner-all' style='z-index:1002'>" + d.bExit + "</a>";
            var E, u = d.zIndex || 999;
            u++;
            if (b.browser.msie && /6.0/.test(navigator.userAgent)) {
              E = '<iframe style="opacity:0" src="javascript:false;document.write(\'\');"></iframe>'
            } else {
              E = ""
            }
            b("<div class='ui-widget-overlay jqgrid-overlay confirm' style='z-index:" + u + ";display:none;'>&nbsp;" + E + "</div><div class='confirm ui-widget-content ui-jqconfirm' style='z-index:" + (u + 1) + "'>" + d.saveData + "<br/><br/>" + g + l + r + "</div>").insertAfter("#" + w);
          ...
          b("#nData", "#" + s).click(function(S) {
            ...
            if (T[0] != -1 && T[1][T[0] + 1]) {
              if (b.isFunction(d.onclickPgButtons)) {
                d.onclickPgButtons("next", b("#" + w), T[1][T[0]])
              }
              m(T[1][T[0] + 1], e, w);
              b(e).setSelection(T[1][T[0] + 1]);
              if (b.isFunction(d.afterclickPgButtons)) {
                d.afterclickPgButtons("next", b("#" + w), T[1][T[0] + 1])
              }
              J(T[0] + 1, T[1].length - 1)
            }
            return false
          });
          b("#pData", "#" + s).click(function(T) {
            if (!f()) {
              return false
            }
            b("#FormError", "#" + s).hide();
            ...
            if (S[0] != -1 && S[1][S[0] - 1]) {
              if (b.isFunction(d.onclickPgButtons)) {
                d.onclickPgButtons("prev", b("#" + w), S[1][S[0]])
              }
              m(S[1][S[0] - 1], e, w);
              b(e).setSelection(S[1][S[0] - 1]);
              if (b.isFunction(d.afterclickPgButtons)) {
                d.afterclickPgButtons("prev", b("#" + w), S[1][S[0] - 1])
              }
              J(S[0] - 1, S[1].length - 1)
            }
            return false
          })
        }
        ...
        function J(T, U, S) {
          if (T == 0) {
            b("#pData", "#" + s).addClass("ui-state-disabled")
          } else {
            b("#pData", "#" + s).removeClass("ui-state-disabled")
          }
          if (T == U) {
            b("#nData", "#" + s).addClass("ui-state-disabled")
          } else {
            b("#nData", "#" + s).removeClass("ui-state-disabled")
          }
        }
        function R() {
          var T = b(e).getDataIDs(),
          S = b("#id_g", "#" + s).val(),
          U = b.inArray(S, T);
          return [U, T]
        }
        ...
        function Q() {
          b(".FormElement", "#" + s).each(function(T) {
            switch (b(this).get(0).type) {
            case "checkbox":
              if (b(this).attr("checked")) {
                C[this.name] = b(this).val()
              } else {
                var S = b(this).attr("offval");
                C[this.name] = S;
                N[this.name] = S
              }
              break;
            case "select-one":
              C[this.name] = b("option:selected", this).val();
              N[this.name] = b("option:selected", this).text();
              break;
            case "select-multiple":
              C[this.name] = b(this).val();
              if (C[this.name]) {
                C[this.name] = C[this.name].join(",")
              } else {
                C[this.name] = ""
              }
              var U = [];
              b("option:selected", this).each(function(V, W) {
                U[V] = b(W).text()
              });
              N[this.name] = U.join(",");
              break;
            ...
            case "button":
              C[this.name] = b(this).val();
              C[this.name] = !e.p.autoencode ? C[this.name] : htmlEncode(C[this.name]);
              break
            }
          });
          return true
        }
        function q(V, ab, Y, ag) {
          var S, T, ad, ae = 0,
          ai, aj, ac, ah = [],
          Z = false,
          aa,
          U,
          W = "<td class='CaptionTD ui-widget-content'>&nbsp;</td><td class='DataTD ui-widget-content'>&nbsp;</td>",
          X = "";
          for (var af = 1; af <= ag; af++) {
            X += W
          }
          if (V != "_empty") {
            Z = b(ab).getInd(ab.rows, V)
          }
          b(ab.p.colModel).each(function(an) {
            S = this.name;
            if (this.editrules && this.editrules.edithidden == true) {
              T = false
            } else {
              T = this.hidden === true ? true: false
            }
            aj = T ? "style='display:none'": "";
            if (S !== "cb" && S !== "subgrid" && this.editable === true && S !== "rn") {
              if (Z === false) {
                ai = ""
              } else {
                if (S == ab.p.ExpandColumn && ab.p.treeGrid === true) {
                  ai = b("td:eq(" + an + ")", ab.rows[Z]).text()
                } else {
                  try {
                    ai = b.unformat(b("td:eq(" + an + ")", ab.rows[Z]), {
                      colModel: this
                    },
                    an)
                  } catch(al) {
                    ai = b("td:eq(" + an + ")", ab.rows[Z]).html()
                  }
                }
              }
              var am = b.extend({},
              ...
              this.formoptions || {}),
              aa = parseInt(frmopt.rowpos) || ae + 1,
              U = parseInt((parseInt(frmopt.colpos) || 1) * 2);
              if (V == "_empty" && am.defaultValue) {
                ai = b.isFunction(am.defaultValue) ? am.defaultValue() : am.defaultValue
              }
              if (!this.edittype) {
                this.edittype = "text"
              }
              ac = createEl(this.edittype, am, ai);
              if (ai == "" && this.edittype == "checkbox") {
                ai = b(ac).attr("offval")
              }
              if (a.checkOnSubmit || a.checkOnUpdate) {
                a._savedData[S] = ai
              }
              b(ac).addClass("FormElement");
              ad = b(Y).find("tr[rowpos=" + aa + "]");
              if (frmopt.rowabove) {
                var ao = b("<tr><td class='contentinfo' colspan='" + (ag * 2) + "'>" + frmopt.rowcontent + "</td></tr>");
                b(Y).append(ao);
                ao[0].rp = aa
              }
              if (ad.length == 0) {
                ad = b("<tr " + aj + " rowpos='" + aa + "'></tr>").addClass("FormData").attr("id", "tr_" + S);
                b(ad).append(X);
                b(Y).append(ad);
                ad[0].rp = aa
              }
              b("td:eq(" + (U - 2) + ")", ad[0]).html(typeof frmopt.label === "undefined" ? ab.p.colNames[an] : frmopt.label);
              b("td:eq(" + (U - 1) + ")", ad[0]).append(frmopt.elmprefix).append(ac).append(frmopt.elmsuffix);
              ah[ae] = an;
              ae++
            }
          });
          if (ae > 0) {
            var ak = b("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='" + (ag * 2 - 1) + "' class='DataTD'><input class='FormElement' id='id_g' type='text' name='id' value='" + V + "'/></td></tr>");
            ak[0].rp = ae + 999;
            b(Y).append(ak);
            if (a.checkOnSubmit || a.checkOnUpdate) {
              a._savedData.id = V
        ...
        function m(T, Y, U) {
          ...
          if (T == "_empty") {
            b(Y.p.colModel).each(function(ad) {
              ac = this.name;
              S = b.extend({},
              this.editoptions || {});
              X = b("#" + ac, "#" + U);
              if (X[0] != null) {
                W = "";
                if (S.defaultValue) {
                  W = b.isFunction(S.defaultValue) ? S.defaultValue() : S.defaultValue;
                  if (X[0].type == "checkbox") {
                    ab = W.toLowerCase();
                    if (ab.search(/(false|0|no|off|undefined)/i) < 0 && ab !== "") {
                      X[0].checked = true;
          ...
          b("table:first tr#" + T + " td", Y.grid.bDiv).each(function(ae) {
            ac = Y.p.colModel[ae].name;
            if (Y.p.colModel[ae].editrules && Y.p.colModel[ae].editrules.edithidden === true) {
              aa = false
            } else {
              aa = Y.p.colModel[ae].hidden === true ? true: false
            }
            if (ac !== "cb" && ac !== "subgrid" && Y.p.colModel[ae].editable === true) {
              if (ac == Y.p.ExpandColumn && Y.p.treeGrid === true) {
                Z = b(this).text()
              } else {
                try {
                  Z = b.unformat(this, {
                    colModel: Y.p.colModel[ae]
                  },
                  ae)
                } catch(ad) {
                  Z = b(this).html()
              ...
              switch (Y.p.colModel[ae].edittype) {
              case "password":
              case "text":
              case "button":
              case "image":
              ...
              case "select":
                Z = b.htmlDecode(Z);
                b("#" + ac + " option", "#" + U).each(function(af) {
                  if (!Y.p.colModel[ae].editoptions.multiple && Z == b(this).text()) {
                    this.selected = true
                  } else {
                    if (Y.p.colModel[ae].editoptions.multiple) {
                      if (b.inArray(b(this).text(), Z.split(",")) > -1) {
                        this.selected = true
                      } else {
                        this.selected = false
                      }
              ...
              case "checkbox":
                ...
                if (Z.search(/(false|0|no|off|undefined)/i) < 0 && Z !== "") {
                  b("#" + ac, "#" + U).attr("checked", true);
                  b("#" + ac, "#" + U).attr("defaultChecked", true)
                } else {
                  b("#" + ac, "#" + U).attr("checked", false);
                  b("#" + ac, "#" + U).attr("defaultChecked", "")
                }
                break
              }
              V++
        ...
        function i() {
          ...
          if (S[0]) {
            if (b.isFunction(a.onclickSubmit)) {
              a.editData = a.onclickSubmit(d) || {}
            }
            if (b.isFunction(a.beforeSubmit)) {
              S = a.beforeSubmit(C, b("#" + w))
            }
          }
          t = a.url ? a.url: e.p.editurl;
          if (S[0]) {
            if (!t) {
              S[0] = false;
              S[1] += " " + b.jgrid.errors.nourl
            }
          }
          if (S[0] === false) {
            b("#FormError>td", "#" + s).html(S[1]);
            b("#FormError", "#" + s).show();
            return
          }
          if (!d.processing) {
            d.processing = true;
            b("#sData", "#" + s).addClass("ui-state-active");
            C.oper = C.id == "_empty" ? "add": "edit";
            C = b.extend(C, a.editData);
            if (typeof(formAuthToken) == 'object') {
              C = b.extend(C,{ authenticity_token: formAuthToken.value, record_id: C.id });
			}
            b.ajax({
              url: t,
              type: a.mtype,
              ...
              complete: function(W, V) {
                if (V != "success") {
                  S[0] = false;
                  S[1] = V + " Status: " + W.statusText + " Error code: " + W.status
                } else {
                  ...
                  if (C.id == "_empty") {
                    ...
                    if (a.closeAfterAdd) {
                      if (a.reloadAfterSubmit) {
                        ...
                        b(e).addRowData(S[2], C, d.addedrow);
                        b(e).setSelection(S[2])
                      }
                      hideModal("#" + h.themodal, {
                        gb: "#gbox_" + A,
                        jqm: d.jqModal
                    ...
                    if (a.reloadAfterSubmit) {
                      b(e).trigger("reloadGrid");
                      if (!a.closeAfterEdit) {
                        b(e).setSelection(C.id)
                      }
                    } else {
                      if (e.p.treeGrid === true) {
                        b(e).setTreeRow(C.id, C)
                      } else {
                        b(e).setRowData(C.id, C)
                      }
                    }
                    if (a.closeAfterEdit) {
                      hideModal("#" + h.themodal, {
                ...
                b("#sData", "#" + s).removeClass("ui-state-active");
                try {
                  b(":input:visible", "#" + w)[0].focus()
                } catch(X) {}
              },
              error: function(X, V, W) {
                b("#FormError>td", "#" + s).html(V + " : " + W);
                b("#FormError", "#" + s).show();
                d.processing = false;
                b("#" + w).data("disabled", false);
                b("#sData", "#" + s).removeClass("ui-state-active")
    ...
    viewGridRow: function(c, d) {
      ...
      return this.each(function() {
        ...
        if (b("#" + i.themodal).html() != null) {
          ...
          b(w.p.colModel).each(function(A) {
            var B = this.formoptions;
            g = Math.max(g, B ? B.colpos || 0 : 0);
            e = Math.max(e, B ? B.rowpos || 0 : 0)
          });
          var v, y = b("<form name='FormPost' id='" + x + "' class='FormGrid'></form>"),
          ...
          z = "<a href='javascript:void(0)' id='cData' class='fm-button ui-state-default ui-corner-all'>" + d.bClose + "</a>";
          v = b("<tr id='Act_Buttons'><td class='navButton ui-widget-content'>" + s + t + "</td><td colspan='" + (g * 2 - 1) + "'class='EditButton ui-widget-content'>" + z + "</td></tr>");
          b(k).append(v);
          v[0].rp = u.length + 100;
          if (e > 0) {
            var f = [];
            b.each(b(k)[0].rows, function(A, B) {
              f[A] = B
            });
            f.sort(function(B, A) {
              if (B.rp > A.rp) {
          ...
          createModal(i, y, d, "#gview_" + w.p.id, b("#gview_" + w.p.id)[0]);
          jQuery("#" + i.themodal).keydown(function(A) {
            if (A.which === 27) {
              if (p) {
                hideModal(this, {
                  gb: d.gbox,
            ...
            if (d.navkeys[0] === true) {
              if (A.which === d.navkeys[1]) {
                b("#pData", "#" + r).trigger("click");
                return false
              }
              if (A.which === d.navkeys[2]) {
                b("#nData", "#" + r).trigger("click");
                return false
              }
            }
          });
          d.closeicon = b.extend([true, "left", "ui-icon-close"], d.closeicon);
          if (d.closeicon[0] == true) {
            b("#cData", "#" + r).addClass(d.closeicon[1] == "right" ? "fm-button-icon-right": "fm-button-icon-left").append("<span class='ui-icon " + d.closeicon[2] + "'></span>")
          }
          viewModal("#" + i.themodal, {
            gbox: "#gbox_" + q,
            jqm: d.jqModal
          });
          b(".fm-button:not(.ui-state-disabled)", "#" + r).hover(function() {
            b(this).addClass("ui-state-hover")
          },
          function() {
            b(this).removeClass("ui-state-hover")
          ...
          b("#nData", "#" + r).click(function(A) {
            b("#FormError", "#" + r).hide();
            var B = h();
            B[0] = parseInt(B[0]);
            if (B[0] != -1 && B[1][B[0] + 1]) {
              if (b.isFunction(d.onclickPgButtons)) {
                d.onclickPgButtons("next", b("#" + x), B[1][B[0]])
              }
              l(B[1][B[0] + 1], w);
              b(w).setSelection(B[1][B[0] + 1]);
              if (b.isFunction(d.afterclickPgButtons)) {
                d.afterclickPgButtons("next", b("#" + x), B[1][B[0] + 1])
              }
              n(B[0] + 1, B[1].length - 1)
            }
            j();
            return false
          });
          b("#pData", "#" + r).click(function(B) {
            b("#FormError", "#" + r).hide();
            var A = h();
            if (A[0] != -1 && A[1][A[0] - 1]) {
              if (b.isFunction(d.onclickPgButtons)) {
                d.onclickPgButtons("prev", b("#" + x), A[1][A[0]])
              }
              l(A[1][A[0] - 1], w);
              b(w).setSelection(A[1][A[0] - 1]);
              if (b.isFunction(d.afterclickPgButtons)) {
                d.afterclickPgButtons("prev", b("#" + x), A[1][A[0] - 1])
              }
              n(A[0] - 1, A[1].length - 1)
            }
            j();
            return false
          })
        ...
        function n(B, C, A) {
          if (B == 0) {
            b("#pData", "#" + r).addClass("ui-state-disabled")
          } else {
            b("#pData", "#" + r).removeClass("ui-state-disabled")
          }
          if (B == C) {
            b("#nData", "#" + r).addClass("ui-state-disabled")
          } else {
            b("#nData", "#" + r).removeClass("ui-state-disabled")
          }
        }
        function h() {
          var B = b(w).getDataIDs(),
          A = b("#id_g", "#" + r).val(),
          C = b.inArray(A, B);
          return [C, B]
        }
        function m(G, M, K, S) {
          ...
          U, W, T = [],
          L = false,
          I = "<td class='CaptionTD ui-widget-content' width='" + d.labelswidth + "'>&nbsp;</td><td class='DataTD ui-helper-reset ui-widget-content'>&nbsp;</td>",
          J = "",
          D = "<td class='CaptionTD ui-widget-content'>&nbsp;</td><td class='DataTD ui-widget-content'>&nbsp;</td>",
          H = ["integer", "number", "currency"],
          P = 0,
          O = 0,
          E,
          B;
          ...
          b(M.p.colModel).each(function(Y) {
            if (this.editrules && this.editrules.edithidden === true) {
              F = false
            } else {
              F = this.hidden === true ? true: false
            }
            if (!F && this.align === "right") {
              if (this.formatter && b.inArray(this.formatter, H) !== -1) {
                P = Math.max(P, parseInt(this.width, 10))
              } else {
                O = Math.max(O, parseInt(this.width, 10))
              }
            }
          });
          E = P !== 0 ? P: O !== 0 ? O: 0;
          L = b(M).getInd(M.rows, G);
          b(M.p.colModel).each(function(Z) {
            C = this.name;
            B = false;
            if (this.editrules && this.editrules.edithidden === true) {
              F = false
            ...
            W = F ? "style='display:none'": "";
            if (C !== "cb" && C !== "subgrid" && this.editable === true) {
              if (L === false) {
                U = ""
              } else {
                if (C == M.p.ExpandColumn && M.p.treeGrid === true) {
                  U = b("td:eq(" + Z + ")", M.rows[L]).text()
                } else {
                  U = b("td:eq(" + Z + ")", M.rows[L]).html()
                }
              }
              B = this.align === "right" && E !== 0 ? true: false;
              var Y = b.extend({},
              this.editoptions || {},
              {
                id: C,
              ...
              this.formoptions || {}),
              aa = parseInt(ad.rowpos) || Q + 1,
              ac = parseInt((parseInt(ad.colpos) || 1) * 2);
              if (ad.rowabove) {
                var ab = b("<tr><td class='contentinfo' colspan='" + (S * 2) + "'>" + ad.rowcontent + "</td></tr>");
                b(K).append(ab);
                ab[0].rp = aa
              }
              N = b(K).find("tr[rowpos=" + aa + "]");
              if (N.length == 0) {
                N = b("<tr " + W + " rowpos='" + aa + "'></tr>").addClass("FormData").attr("id", "tr_" + C);
                b(N).append(J);
                b(K).append(N);
                N[0].rp = aa
              }
              b("td:eq(" + (ac - 2) + ")", N[0]).html("<b>" + (typeof ad.label === "undefined" ? M.p.colNames[Z] : ad.label) + "</b>");
              b("td:eq(" + (ac - 1) + ")", N[0]).append("<span>" + U + "</span>").attr("id", C);
              if (B) {
                b("td:eq(" + (ac - 1) + ") span", N[0]).css({
                  "text-align": "right",
                  width: E + "px"
                })
              }
          ...
          if (Q > 0) {
            var X = b("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='" + (S * 2 - 1) + "' class='DataTD'><input class='FormElement' id='id_g' type='text' name='id' value='" + G + "'/></td></tr>");
            X[0].rp = Q + 99;
            b(K).append(X)
          }
          return T
        ...
        function l(E, F) {
          var A, G, D = 0,
          C, B;
          b("#" + E + " td", F.grid.bDiv).each(function(H) {
            A = F.p.colModel[H].name;
            if (F.p.colModel[H].editrules && F.p.colModel[H].editrules.edithidden === true) {
              G = false
            } else {
              G = F.p.colModel[H].hidden === true ? true: false
            }
            if (A !== "cb" && A !== "subgrid" && F.p.colModel[H].editable === true) {
              if (A == F.p.ExpandColumn && F.p.treeGrid === true) {
                C = b(this).text()
              } else {
                C = b(this).html()
              }
              A = A.replace(".", "\\.");
              B = b.extend({},
              F.p.colModel[H].editoptions || {});
              b("#" + A + " span", "#" + r).html(C);
              if (G) {
                b("#" + A, "#" + r).parents("tr:first").hide()
              }
              D++
            }
          });
    ...
    delGridRow: function(c, d) {
      ...
      return this.each(function() {
        ...
        var l = typeof d.beforeShowForm === "function" ? true: false,
        f = typeof d.afterShowForm === "function" ? true: false,
        e = j.p.id,
        g = {
          themodal: "delmod" + e,
          modalhead: "delhd" + e,
        ...
        if (b("#" + g.themodal).html() != null) {
          b("#DelData>td", "#" + i).text(c);
          b("#DelError", "#" + i).hide();
          if (d.processing === true) {
            d.processing = false;
            b("#dData", "#" + i).removeClass("ui-state-active")
          }
          if (l) {
            d.beforeShowForm(b("#" + i))
          }
          viewModal("#" + g.themodal, {
            gbox: "#gbox_" + e,
            jqm: d.jqModal,
            jqM: false
          });
          ...
          var k = b("<table id='" + i + "' class='DelTable' width='100%'><tbody></tbody></table>");
          b(k).append("<tr id='DelError' style='display:none'><td >&nbsp;</td></tr>");
          b(k).append("<tr id='DelData' style='display:none'><td >" + c + "</td></tr>");
          b(k).append('<tr><td class="delmsg">' + d.msg + "</td></tr><tr><td >&nbsp;</td></tr>");
          var h = "<a href='javascript:void(0)' id='dData' class='fm-button ui-state-default ui-corner-all'>" + d.bSubmit + "</a>",
          m = "<a href='javascript:void(0)' id='eData' class='fm-button ui-state-default ui-corner-all'>" + d.bCancel + "</a>";
          b(k).append("<tr><td align='right' class='DelButton'>" + h + "&nbsp;" + m + "</td></tr>");
          d.gbox = "#gbox_" + e;
          createModal(g, k, d, "#gview_" + j.p.id, b("#gview_" + j.p.id)[0]);
          b(".fm-button", "#" + i).hover(function() {
            b(this).addClass("ui-state-hover")
          },
          function() {
            b(this).removeClass("ui-state-hover")
          ...
          if (d.delicon[0] == true) {
            b("#dData", "#" + i).addClass(d.delicon[1] == "right" ? "fm-button-icon-right": "fm-button-icon-left").append("<span class='ui-icon " + d.delicon[2] + "'></span>")
          }
          if (d.cancelicon[0] == true) {
            b("#eData", "#" + i).addClass(d.cancelicon[1] == "right" ? "fm-button-icon-right": "fm-button-icon-left").append("<span class='ui-icon " + d.cancelicon[2] + "'></span>")
          }
          b("#dData", "#" + i).click(function(q) {
            var o = [true, ""];
            var p = b("#DelData>td", "#" + i).text();
            if (typeof d.onclickSubmit === "function") {
              d.delData = d.onclickSubmit(d) || {}
            }
            if (typeof d.beforeSubmit === "function") {
              o = d.beforeSubmit(p)
            }
            var n = a.url ? a.url: j.p.editurl;
            if (!n) {
              o[0] = false;
              o[1] += " " + b.jgrid.errors.nourl
            }
            if (o[0] === false) {
              b("#DelError>td", "#" + i).html(o[1]);
              b("#DelError", "#" + i).show()
            } else {
              if (!d.processing) {
                d.processing = true;
                ...
                b.ajax({
                  ...
                  type: d.mtype,
                  data: r,
                  complete: function(v, t) {
                    if (t != "success") {
                      o[0] = false;
                      o[1] = t + " Status: " + v.statusText + " Error code: " + v.status
                    } else {
        ...
        if (d.closeOnEscape === true) {
          setTimeout(function() {
            b(".ui-jqdialog-titlebar-close", "#" + g.modalhead).focus()
          },
          0)
        }
      })
    ...
    navGrid: function(f, h, e, g, d, c, i) {
      ...
      return this.each(function() {
        ...
        b("body").append("<div id='testpg' class='ui-jqgrid ui-widget ui-widget-content' style='font-size:" + k + ";visibility:hidden;' ></div>");
        o = b(q).clone(false).appendTo("#testpg").width();
        b("#testpg").remove();
    ...
    if (p != null) {
      ...
      j.find(".ui-search").click(function(C) {
        ...
        B.find(".sf").each(function(D) {
          ...
          var E = jQuery(this).find(".data input, .data select :selected").val();
          if (!n.stringResult) {
            z.rules.push({
              field: G,
              op: F,
  ...
  a.fn.extend({
    editRow: function(c, i, h, j, b, e, d, f, g) {
      return this.each(function() {
        ...
        var p;
        if (!n.p.multiselect) {
          k = a(n).getInd(n.rows, c);
          if (k === false) {
            return
          }
          l = a(n.rows[k]).attr("editable") || "0";
          if (l == "0") {
            q = n.p.colModel;
            a("td", n.rows[k]).each(function(w) {
              t = q[w].name;
              p = q[w].hidden === true ? true: false;
              try {
                o = a.unformat(this, {
                  colModel: q[w]
                },
              ...
              r[t] = o;
              if (t !== "cb" && t !== "subgrid" && q[w].editable === true && !p && t != "rn") {
                if (s === null) {
                  s = w
                }
                a(this).html("");
                ...
                var x = createEl(q[w].edittype, v, o, a(this));
                a(x).addClass("editable");
                a(this).append(x);
                if (q[w].edittype == "select" && q[w].editoptions.multiple === true && a.browser.msie) {
                  a(x).width(a(x).width())
                }
                m++
              }
            ...
            if (m > 0) {
              r.id = c;
              n.p.savedRow.push(r);
              a(n.rows[k]).attr("editable", "1");
              a("td:eq(" + s + ") input", n.rows[k]).focus();
              if (i === true) {
                a(n.rows[k]).bind("keydown", function(u) {
                  if (u.keyCode === 27) {
                    a(n).restoreRow(c, g)
                  }
                  if (u.keyCode === 13) {
                    a(n).saveRow(c, j, b, e, d, f);
                    return false
                  }
                  u.stopPropagation()
                })
    ...
    saveRow: function(h, g, e, f, d, c, b) {
      return this.each(function() {
        ...
        i = a(o).getInd(o.rows, h);
        if (i === false) {
          return
        }
        j = a(o.rows[i]).attr("editable");
        e = e ? e: o.p.editurl;
        if (j === "1" && e) {
          a("td", o.rows[i]).each(function(u) {
            t = o.p.colModel[u].name;
            if (t !== "cb" && t !== "subgrid" && o.p.colModel[u].editable === true) {
              if (o.p.colModel[u].hidden === true) {
                ...
                case "textarea":
                case "button":
                  p[t] = !o.p.autoencode ? a("input, textarea", this).val() : htmlEncode(a("input, textarea", this).val());
                  break;
                case "select":
          ...
          if (!o.grid.hDiv.loading) {
            ...
            if (e == "clientArray") {
              ...
              if (typeof(formAuthToken) == 'object') {
                p = a.extend(p,{ authenticity_token: formAuthToken.value, record_id: p.id, oper: 'edit'});
	          }
              a.ajax({
                url: e,
                data: p,
    ...
    saveCell: function(c, b) {
      return this.each(function() {
        ...
        if (l != null) {
          ...
          case "textarea":
          case "button":
            q = !j.p.autoencode ? a("#" + c + "_" + r.replace(".", "\\."), j.rows[c]).val() : htmlEncode(a("#" + c + "_" + r.replace(".", "\\."), j.rows[c]).val());
            o = q;
            break
          }
  ...
  a.fn.extend({
      ...
      return this.each(function() {
        ...
        a("td:eq(" + c + ")", b).click(function(p) {
          if (a(this).hasClass("sgcollapsed")) {
            ...
            n = a(m).attr("id");
            h = true;
            if (a.isFunction(l.p.subGridBeforeExpand)) {
              h = l.p.subGridBeforeExpand(o + "_" + n, n)
            }
            if (h === false) {
              return false
            }
            j = 0;
            a.each(l.p.colModel, function(r, q) {
              if (this.hidden === true) {
                j++
              }
            });
            g = "<tr role='row' class='ui-subgrid'>" + i + "<td><span class='ui-icon ui-icon-carat-1-sw'/></td><td colspan='" + parseInt(l.p.colNames.length - 1 - j) + "' class='ui-widget-content subgrid-data'><div id=" + o + "_" + n + " class='tablediv'>";
            a(this).parent().after(g + "</div></td></tr>");
            if (a.isFunction(l.p.subGridRowExpanded)) {
              l.p.subGridRowExpanded(o + "_" + n, n)
            } else {
              k(m)
            }
            ...
            if (a(this).hasClass("sgexpanded")) {
              h = true;
              if (a.isFunction(l.p.subGridRowColapsed)) {
                m = a(this).parent();
                n = a(m).attr("id");
                h = l.p.subGridRowColapsed(o + "_" + n, n)
              }
              if (h === false) {
                return false
              }
        ...
        var k = function(t) {
          ...
          if (!l.p.subGridModel[0]) {
            return false
          }
          if (l.p.subGridModel[0].params) {
            for (q = 0; q < l.p.subGridModel[0].params.length; q++) {
              for (r = 0; r < l.p.colModel.length; r++) {
                if (l.p.colModel[r].name == l.p.subGridModel[0].params[q]) {
                  u[l.p.colModel[r].name] = a("td:eq(" + r + ")", t).text().replace(/\&nbsp\;/ig, "")
                }
              }
            }
          }
          if (!l.grid.hDiv.loading) {
            l.grid.hDiv.loading = true;
            a("#load_" + l.p.id).show();
            if (!l.p.subgridtype) {
              l.p.subgridtype = l.p.datatype
            }
            if (a.isFunction(l.p.subgridtype)) {
              l.p.subgridtype(u)
            }
            switch (l.p.subgridtype) {
            case "xml":
              a.ajax({
                type:
                l.p.mtype,
        ...
        var e = function(q, p, s) {
          var r = a("<td align='" + l.p.subGridModel[0].align[s] + "'></td>").html(p);
          a(q).append(r)
        };
        var d = function(u, s) {
          var w, t, v, p, r = a("<table cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>"),
          q = a("<tr></tr>");
          for (t = 0; t < l.p.subGridModel[0].name.length; t++) {
            w = a("<th class='ui-state-default ui-th-column'></th>");
            a(w).html(l.p.subGridModel[0].name[t]);
            a(w).width(l.p.subGridModel[0].width[t]);
            a(q).append(w)
          }
          a(r).append(q);
          if (u) {
            p = l.p.xmlReader.subgrid;
            a(p.root + " " + p.row, u).each(function() {
              q = a("<tr class='ui-widget-content ui-subtblcell'></tr>");
              if (p.repeatitems === true) {
                a(p.cell, this).each(function(z) {
                  e(q, a(this).text() || "&nbsp;", z)
                })
              } else {
                var y = l.p.subGridModel[0].mapping;
                if (y) {
                  for (t = 0; t < y.length; t++) {
                    e(q, a(y[t], this).text() || "&nbsp;", t)
                  }
                }
              }
              a(r).append(q)
          ...
          var x = a("table:first", l.grid.bDiv).attr("id") + "_";
          a("#" + x + s).append(r);
          l.grid.hDiv.loading = false;
          a("#load_" + l.p.id).hide();
          return false
        };
        var f = function(w, t) {
          var y, A, u, x, p, r = a("<table cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>"),
          q = a("<tr></tr>");
          for (u = 0; u < l.p.subGridModel[0].name.length; u++) {
            y = a("<th class='ui-state-default ui-th-column'></th>");
            a(y).html(l.p.subGridModel[0].name[u]);
            a(y).width(l.p.subGridModel[0].width[u]);
            a(q).append(y)
          }
          a(r).append(q);
          if (w) {
            p = l.p.jsonReader.subgrid;
            A = w[p.root];
            if (typeof A !== "undefined") {
              for (u = 0; u < A.length; u++) {
                ...
                if (p.repeatitems === true) {
                  ...
                  var v = l.p.subGridModel[0].mapping;
                  if (v.length) {
          ...
          var z = a("table:first", l.grid.bDiv).attr("id") + "_";
          a("#" + z + t).append(r);
          l.grid.hDiv.loading = false;
          a("#load_" + l.p.id).hide();
          return false
        };
        l.subGridXml = function(q, p) {
          d(q, p)
        };
        l.subGridJson = function(q, p) {
          f(q, p)
        }
      })
    },
    expandSubGridRow: function(b) {
      return this.each(function() {
        ...
        if (e.p.subGrid === true) {
          var c = a(this).getInd(e.rows, b, true);
          if (c) {
...
(function(a) {
  a.fn.extend({
    setTreeNode: function(b, c) {
      return this.each(function() {
        var k = this;
        if (!k.grid || !k.p.treeGrid) {
          return
        }
        var n = 0,
        l = 0;
        if (!k.p.expColInd) {
          for (var q in k.p.colModel) {
            if (k.p.colModel[q].name == k.p.ExpandColumn) {
              n = l;
              k.p.expColInd = n;
              break
            }
        ...
        var m = k.p.treeReader.expanded_field;
        var g = k.p.treeReader.leaf_field;
        var f = k.p.treeReader.level_field;
        c.level = b[f];
        if (k.p.treeGridModel == "nested") {
          c.lft = b[k.p.treeReader.left_field];
          c.rgt = b[k.p.treeReader.right_field];
          if (!b[g]) {
            b[g] = (parseInt(c.rgt, 10) === parseInt(c.lft, 10) + 1) ? "true": "false"
          }
        } else {
          c.parent_id = b[k.p.treeReader.parent_id_field]
        }
        var o = parseInt(c.level, 10),
        j,
        p;
        if (k.p.tree_root_level === 0) {
          j = o + 1;
          p = o
        } else {
          j = o;
        ...
        a(d).addClass("tree-wrap").width(j * 18);
        var h = document.createElement("div");
        a(h).css("left", p * 18).addClass("ui-icon");
        d.appendChild(h);
        if (b[g] == "true") {
          a(h).addClass(k.p.treeIcons.leaf + " tree-leaf");
          c.isLeaf = true
        } else {
          if (b[m] == "true") {
            a(h).addClass(k.p.treeIcons.minus + " tree-minus treeclick");
            c.expanded = true
          } else {
            a(h).addClass(k.p.treeIcons.plus + " tree-plus treeclick");
            c.expanded = false
          }
          c.isLeaf = false
        }
        if (parseInt(b[f], 10) !== parseInt(k.p.tree_root_level, 10)) {
          if (!a(k).isVisibleNode(c)) {
            a(c).css("display", "none")
          }
        }
        var e = a("td:eq(" + n + ")", c).html();
        var r = a("td:eq(" + n + ")", c).html("<span>" + e + "</span>").prepend(d);
        a(".treeclick", r).click(function(t) {
          var s = t.target || t.srcElement;
          var i = a(s, k.rows).parents("tr:first")[0].rowIndex;
          if (!k.rows[i].isLeaf) {
            if (k.rows[i].expanded) {
              a(k).collapseRow(k.rows[i]);
              a(k).collapseNode(k.rows[i])
            } else {
              a(k).expandRow(k.rows[i]);
              a(k).expandNode(k.rows[i])
            }
          }
          return false
        });
        if (k.p.ExpandColClick === true) {
          a("span", r).css("cursor", "pointer").click(function(t) {
            var s = t.target || t.srcElement;
            var i = a(s, k.rows).parents("tr:first")[0].rowIndex;
            if (!k.rows[i].isLeaf) {
              if (k.rows[i].expanded) {
    ...
    setTreeGrid: function() {
      return this.each(function() {
        ...
        if (b.p.treeGridModel == "nested") {
          ...
          if (b.p.treeGridModel == "adjacency") {
            b.p.treeReader = a.extend({
              level_field: "level",
    ...
    getNodeChildren: function(c) {
      ...
      this.each(function() {
        ...
        case "nested":
          ...
          d = parseInt(c.rgt, 10),
          f = parseInt(c.level, 10);
          a(this.rows).slice(1).each(function(h) {
    ...
    jqGridImport: function(b) {
      ...
      return this.each(function() {
        ...
        var d = function(h, m) {
          ...
          if (xmlJsonClass.xml2json && a.parse) {
        ...
        case "xmlstring":
          if (b.impstring && typeof b.impstring == "string") {
            var c = a.stringToDoc(b.impstring);
            if (c) {
              d(c, b);
              if (a.isFunction(b.importComplete)) {
                b.importComplete()
    ...
    case "string":
      ...
      for (e = 0; e < b; e += 1) {
        ...
        if (g >= " ") {
          ...
          default:
            g = g.charCodeAt();
            f += "\\u00" + Math.floor(g / 16).toString(16) + (g % 16).toString(16)
          }
        }
      }
      return f + '"';
  ...
  a.fn.extend({
    setColumns: function(b) {
      ...
      return this.each(function() {
        ...
        var l = typeof b.beforeShowForm === "function" ? true: false;
        ...
        if (a("#" + f.themodal).html() != null) {
          ...
          var k = a("<table id='" + h + "' class='ColTable'><tbody></tbody></table>");
          for (i = 0; i < this.p.colNames.length; i++) {
            if (!j.p.colModel[i].hidedlg) {
              a(k).append("<tr><td ><input type='checkbox' id='col_" + this.p.colModel[i].name + "' class='cbox' value='T' " + ((this.p.colModel[i].hidden === false) ? "checked": "") + "/><label for='col_" + this.p.colModel[i].name + "'>" + this.p.colNames[i] + "(" + this.p.colModel[i].name + ")</label></td></tr>")
            }
          }
          var g = "<input id='dData' type='button' value='" + b.bSubmit + "'/>";
          var m = "<input id='eData' type='button' value='" + b.bCancel + "'/>";
          a(k).append("<tr><td class='ColButton'>" + g + "&nbsp;" + m + "</td></tr>");
          b.gbox = "#gbox_" + c;
          createModal(f, k, b, j.grid.hDiv, j.grid.hDiv);
          a("#dData", "#" + h).click(function(n) {
            for (i = 0; i < j.p.colModel.length; i++) {
              if (!j.p.colModel[i].hidedlg) {
                if (a("#col_" + j.p.colModel[i].name).attr("checked")) {
                  a(j).showCol(j.p.colModel[i].name);
                  a("#col_" + j.p.colModel[i].name).attr("defaultChecked", true)
                } else {
                  a(j).hideCol(j.p.colModel[i].name);
                  a("#col_" + j.p.colModel[i].name).attr("defaultChecked", "")
                }
              }
            }
          ...
          a("#dData, #eData", "#" + h).addClass("ui-state-default ui-corner-all").css({
            padding: ".2em .5em",
            cursor: "pointer"
          }).hover(function() {
...
function tableToGrid(a) {
  jQuery(a).each(function() {
    ...
    var o = jQuery("input[type=checkbox]:first", jQuery(this));
    var g = jQuery("input[type=radio]:first", jQuery(this));
    var c = o.length > 0;
    var f = !c && g.length > 0;
    var i = c || f;
    var h = o.attr("name") || g.attr("name");
    var k = [];
    var n = [];
    ...
    for (var j = 0; j < e.length; j++) {
      ...
      jQuery(this).addRowData(b, e[j])
    }
    for (var j = 0; j < l.length; j++) {
      jQuery(this).setSelection(l[j])
    }
  })
};